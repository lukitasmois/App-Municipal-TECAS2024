...
const VistaHabilitaciones = () => {
    ...
    if(habilitacionesArray.length === 0){
        ...
        <form onSubmit={handleSubmit}>
            ...
            <small id="emailHelp" class="form-text text-muted">Ingrese numero de legajo.</small>
            <input type='number' value={inputValue} onChange={handleChange} class="form-control"></input>
            </div>
        </form>
        </>
    }else{
        return<>
            <TablaHabilitaciones habilitacion = {habilitacionesArray[0]}></TablaHabilitaciones>
        </>
    }
